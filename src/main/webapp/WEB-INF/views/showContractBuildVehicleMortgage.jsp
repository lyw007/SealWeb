...
ProtocolNoService.prototype.setBatchProtocolNO = function(){
    ...
    ProtocolNoService.prototype.setProtocolNo("loanMortgageNoGuaranteeProtocolNo");
...
PageService.prototype.downOneContractPdf = function(actionUrl, vehicleMortageContractType){
    ProtocolNoService.prototype.setBatchProtocolNO();
    if(actionUrl == '' || vehicleMortageContractType == ''){
        alert("请求有误!");
    }
    document.forms[0].vehicleMortageContractType.value = vehicleMortageContractType;
    if(vehicleMortageContractType == 'CARLOAN_FINANCING_SERVICES_3PARTY'){
        document.forms[0].protocolNo.value = document.forms[0].financingservices3partyProtocolNo.value;
    }else if(vehicleMortageContractType == 'GUARANTEED_LOAN_AGREEMENT'){
        document.forms[0].protocolNo.value = document.forms[0].loanAgreementProtocolNo.value;
    }else if(vehicleMortageContractType == 'MORTGAGE_NO_GUARANTEE'){
        document.forms[0].protocolNo.value = document.forms[0].loanMortgageNoGuaranteeProtocolNo.value;
    }else if(vehicleMortageContractType == 'POWER_OFATTORNEY'){
        document.forms[0].protocolNo.value = document.forms[0].powerOfattorneyProtocolNo.value;
    }else if(vehicleMortageContractType == 'CONFIRMATION_RECEIPT'){
        document.forms[0].protocolNo.value = document.forms[0].confirmationReceiptProtocolNo.value;
    }else if(vehicleMortageContractType == 'CAR_STRANSFER'){
        document.forms[0].protocolNo.value = document.forms[0].carloanCarstransferProtocolNo.value;
    }else if(vehicleMortageContractType == 'EXTENDING_LOAN_AGREEMENT'){
...
<body>
<form:form action="downBatchContractVehicleMortgage" id="downBatchContractVehicleMortgage" method="post" commandName="apiContractVehicleMortage"> 
    <input type="reset" name="reset" style="display: none;" />
    <!-- 隐藏参数通过(通用) -->
    <input type="hidden" name="vehicleMortageContractType" id="vehicleMortageContractType"/>
    ...
    <input type="hidden" name="loanMortgageNoGuaranteeProtocolNo" id="loanMortgageNoGuaranteeProtocolNo" />
    ...
    <div class="contmanage">
        ...
        <div class="tabCont-title">
            <div class="comWin">
                <div class="tabIcon">
                    <span class="active">车贷业务-车辆<i>抵</i>押</span>
       ...
       <div class="tabCont-cont">
            <div class="comWin">
                <div class="rowDiv">
                    ...
                    <div class="tdDiv">
                        <div class="nameInfo"><h2>借款人名称：</h2><p>（委托人/抵押人/出让方/委托人）</p></div>
                    ...
                    <div class="tdDiv">
                        <div class="nameInfo"><h2>借款人身份证号/注册号：</h2><p>（委托人/抵押人/出让方/委托人）</p></div>
                        <div class="textInfo"><input name="auditeeIdNumber" id="auditeeIdNumber"  maxlength="18" class="text" /></div>
                    </div>
                    
                    <div class="tdDiv">
                        <div class="nameInfo"><h2>担保方名称：</h2><p>（抵押权人/受让方/受托人）</p></div>
                    ...
                    <div class="tdDiv">
                        <div class="nameInfo"><h2>借款本金：</h2><p>（融资金额/借款金额/出借款）</p></div>
        ...
        <div class="connt">
            ...
            <div class="table">
                ...
                <div class="rowDiv">
                    ...
                    <div class="tdDiv tdDiv02"><p><a onclick="PageService.prototype.downOneContractPdf('downOneContract', 'MORTGAGE_NO_GUARANTEE')" style="cursor:pointer">抵押反担保(办理抵押登记)</a></p></div>
                    <div class="tdDiv tdDiv03">
                        <div class="select select3" style="z-index:121">
                            <select name="loanMortgageNoGuaranteeOption" >
                                 <c:forEach var="item" items="${contractBuildOption}">
                                    <option value="${item.key}">${item.value}</option> 
                                </c:forEach>
                            </select>
            ...
            <div class="btn">
                <a onclick="PageService.prototype.downBatchContractPdf('downBatchContractVehicleMortgage');"   style="cursor:pointer"  title="">一键下载</a>
            </div>
        </div>   
    </div>
</form:form>
