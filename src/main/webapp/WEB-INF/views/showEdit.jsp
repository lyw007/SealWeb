...
<form id="showEdit" name="showEdit" method="post" action="showEdit">
...
<table cellpadding="3" cellspacing="1" width="90%" align="center">
    <tr>
        <td>请求参数:</td>
        <td>
            <textarea rows="6" cols="200" id="parametersJson" name="parametersJson">${contract.parameters }</textarea>
        </td>
    </tr>
    <tr>
        <td>时间:</td>
    ...
    <tr>
        <td>模板:</td>
        <td>${contract.contractBatch.template.templateName }</td>
    </tr>
    <tr>
        <td>执行结果:</td>
